...
while count <= 10000:
    ...
    plt.plot(px, py, '#080000', linewidth=25)
    # plt.plot(x, y, 'bo') this adds dots
    plt.axis('off')
    plt.tight_layout()
    plt.savefig('1.6/'+filecount+'.png', bbox_inches='tight',transparent=True, pad_inches=0, dpi=519.5)
    plt.close()
    count += 1